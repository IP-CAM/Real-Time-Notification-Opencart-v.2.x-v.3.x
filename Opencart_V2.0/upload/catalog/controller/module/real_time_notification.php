...
class ControllerModuleRealTimeNotification extends Controller {
	...
	public function notification() {
		...
		if ($this->config->get('real_time_notification_status')) {
			$this->load->model('module/real_time_notification');
			$this->load->language('module/real_time_notification');
			...
			$recent_sales = $this->model_module_real_time_notification->getRecentSales($latest_order_id);
